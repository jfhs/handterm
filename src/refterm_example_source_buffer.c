...
int IsInBuffer(source_buffer *Buffer, size_t AbsoluteP)
{
...
source_buffer_range AdvanceRange(source_buffer_range Source, size_t ToAbsoluteP, size_t Count)
{
...
source_buffer_range ConsumeCount(source_buffer_range Source, size_t Count)
{
    source_buffer_range Result = Source;
...
source_buffer_range ReadSourceAt(source_buffer *Buffer, size_t AbsoluteP, size_t Count)
{
...
size_t GetCurrentAbsoluteP(source_buffer *Buffer)
{
...
source_buffer_range GetNextWritableRange(source_buffer *Buffer, size_t MaxCount)
{
...
void CommitWrite(source_buffer *Buffer, size_t Size)
{
    Assert(Buffer->RelativePoint < Buffer->DataSize);
