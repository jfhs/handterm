...
int D3D11RendererIsValid(d3d11_renderer* Renderer)
{
...
void ActivateD3D11DebugInfo(ID3D11Device* Device)
{
...
IDXGIFactory2* AcquireDXGIFactory(ID3D11Device* Device)
{
...
IDXGISwapChain2* AcquireDXGISwapChain(ID3D11Device* Device, HWND Window, int UseComputeShader)
{
...
void ReleaseD3DCellBuffer(d3d11_renderer* Renderer)
{
...
void ReleaseD3DGlyphCache(d3d11_renderer* Renderer)
{
...
void ReleaseD3DGlyphTransfer(d3d11_renderer* Renderer)
{
...
void ReleaseD3D11RenderTargets(d3d11_renderer* Renderer)
{
...
void ReleaseD3D11Renderer(d3d11_renderer* Renderer)
{
...
void RendererDraw(TermOutputBuffer* Terminal, uint32_t Width, uint32_t Height, uint32_t BlinkModulate)
{
    ...
    if (Renderer->RenderView || Renderer->RenderTarget)
    {
        ...
        AssertHR(hr);
        {
            ...
            memcpy(Cells, Terminal->RenderCells, Terminal->size.X * Terminal->size.Y * sizeof(renderer_cell));
        }
